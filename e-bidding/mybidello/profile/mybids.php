...
<div id="header-wrapper">
	...
	echo "<a href='mybids.php?start=0'  style=' float:left; margin-left:600px; color:white; font:Verdana; margin-top:5px;  font-size:14px;'  >myBids</a>";
	echo "<a href='mywins.php?start=0'  style=' float:left; margin-left:30px; color:white; font:Verdana; margin-top:5px;  font-size:14px;'  >myWins</a>";
	
	echo "<a href='myitems.php?start=0'  style=' float:left; margin-left:30px; color:white; font:Verdana; margin-top:5px;  font-size:14px;'  >myItems</a>";
	
	echo "<a href='../postItem/postItem.php?start=0'  style=' float:left; margin-left:30px; color:white; font:Verdana; margin-top:5px;  font-size:14px;'  >post an Item</a>";
	}
	else
	{
	...
	?>
		...
		<div id="menu">
			<ul><li class="icon icon-ok current_page_item"><a href="../../index1.php?start=0&session=0" accesskey="1" title="">homepage</a></li>
...
<div id="wrapper">
	<div id="page" class="container">
		<div id="content">
          ...
          <br/>
          <br/>
          <li ><a href="mywins.php?start=0"><h3>My Wins</h3></a></li>
          <br/>
          <br/>
          <br/>
          <li ><a href="myitems.php?start=0"><h3>My Items</h3></a></li>
          <br/>
          <br/>
          <br/>
          <li ><a href="mybids.php?start=0"><h3>My Bids</h3></a></li>
          <br/>
          <br/>
		...
		<div id="sidebar">
			<div id="stwo-col">
				<div class="sbox1">
					<h1>My Bids</h1>
                <br/>
				<span class="byline">All the items you bid upon!</span>
    <br/>              
   ...
   <?php
		...
		$start=$_GET['start'];
		$record_count= mysql_num_rows(mysql_query("SELECT * FROM bidders WHERE bidderUserName='$user' "));
		
		$max_pages =$record_count / $per_page;
		
		if(!$start)
		$start=0;
		$bid= mysql_query("SELECT * FROM bidders WHERE bidderUserName='$user' LIMIT $start , $per_page ");
		...
		while ( $row = mysql_fetch_assoc($bid))
			{
				...
				$q= mysql_query("SELECT * FROM bidinfo WHERE randomID='$id' and itemFlag='0'");
			while($row2= mysql_fetch_assoc($q))
			{
					$bidobject=$row2['bidObject'];
			...
			echo "<form  style='margin-left:650px; margin-top:-20px;'; action='../../details/details.php' method='get'> <input type='hidden' value='$id' name='product'> <input style='background-color:#0c696e; color:#FFF; ' type='submit' value='view details' name='details'></form>";
		...
		$next = $start + $per_page;
			...
			echo "<br/><br/> <br/> <br/>";
		if(!($start<=0))
		echo "<a href='mybids.php?start=$prev' style='margin-left:400px;'>Prev</a>"."&nbsp;";
		...
		for ($x=0;$x<$record_count;$x=$x+$per_page)
		{
			if($start!=$x)
			{
				...
				echo "<a href='mybids.php?start=$x' style='margin-left:4px;'>$i</a>"."&nbsp;";
			...
			else
			{
				if($start<=0)
				{
					echo "<a href='mybids.php?start=$x' style='margin-left:400px;'><b>$i</b></a>"."&nbsp;";
				}
				else
				{
				echo "<a href='mybids.php?start=$x' style='margin-left:4px;'><b>$i</b></a>"."&nbsp;";
				}
			}
			$i++;
		...
		echo "<a href='mybids.php?start=$next' style='margin-left:4px;'>Next</a>";
		}	

		else
		{
			echo "<div style='height:140px; width:950px; float:left;'>";
			echo "&nbsp;&nbsp;&nbsp;"."<h4 style=' font-size:18; margin-left:5px; margin-top:10px;';>You have not bid on any items yet!</h4>"."<br/>";
			echo "</div>";
		}
...
<div style="margin-left:200px; margin-top:30px;">
 &nbsp;||&nbsp;s<a href="../../index.php?start=0">Homepage</a> &nbsp;||&nbsp; <a href="../../aboutus/aboutus.php">About us</a> &nbsp;||&nbsp;<a href="../../seenow/seenow.php?website_string=popularity&start=0&search=Search+now">Bids</a> &nbsp;||&nbsp; <a href="../../winners/winners.php?start=0">Winners</a> &nbsp;||&nbsp;<a href="../../contactus/contactus.php">Contact Us</a>  &nbsp;||&nbsp; <a href="#">Sitemap</a> &nbsp;||&nbsp; <a href="../../faq/faq.php">FAQ's</a> &nbsp;||&nbsp; <a href="../../disclaimer/disclaimer.php">Disclaimer</a> &nbsp;||&nbsp; 
</div>
<br/>
