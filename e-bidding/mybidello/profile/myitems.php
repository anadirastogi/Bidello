...
<div id="wrapper">
		...
		<div id="sidebar">
			<div id="stwo-col">
				<div class="sbox1">
					<h1>My Items</h1>
                <br/>
				<span class="byline">All the items you have posted.</span>
    <br/>              
   ...
   <?php
		...
		$per_page=5;
		$start=$_GET['start'];
		$record_count= mysql_num_rows(mysql_query("SELECT * FROM bidinfo WHERE sellerID='$user' and itemflag='0' "));
		...
		$win= mysql_query("SELECT * FROM bidinfo WHERE sellerID='$user' and itemflag='0' LIMIT $start , $per_page ");
		$c=mysql_num_rows($win);
		...
		$next = $start + $per_page;
			...
			echo "<br/><br/> <br/> <br/>";
		if(!($start<=0))
		echo "<a href='myitems.php?start=$prev' style='margin-left:400px;'>Prev</a>"."&nbsp;";
		...
		for ($x=0;$x<$record_count;$x=$x+$per_page)
		{
			if($start!=$x)
			{
				...
				echo "<a href='myitems.php?start=$x' style='margin-left:4px;'>$i</a>"."&nbsp;";
			...
			else
			{
				if($start<=0)
				{
					echo "<a href='myitems.php?start=$x' style='margin-left:400px;'><b>$i</b></a>"."&nbsp;";
				}
				else
				{
				echo "<a href='myitems.php?start=$x' style='margin-left:4px;'><b>$i</b></a>"."&nbsp;";
				}
			}
			$i++;
		...
		echo "<a href='myitems.php?start=$next' style='margin-left:4px;'>Next</a>";
		}	
		...
		{
			echo "<div style='height:140px; width:950px; float:left;'>";
			echo "&nbsp;&nbsp;&nbsp;"."<h4 style=' font-size:18; margin-left:5px; margin-top:10px;';>You have not posted any items yet !</h4>"."<br/>";
			echo "</div>";
		}
